    ...
    <main>
        ...
        <div id="roster-tab" class="tab-content active">
                ...
                <div id="export-wrapper" style="background-color: #ffffff; padding: 1.5rem; border-radius: 0.5rem;">
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 0.5rem; margin-top: 2rem;">
                        <h3 style="font-size: 1rem; font-weight: 600; color: #1e293b; margin: 0;">
                            Shift & Day Legend <span style="font-size: 0.75rem; font-weight: 400; color: #64748b;">(Tick/untick to enable/disable assignment in timetable)</span>
                        </h3>
                        <div style="display: flex; gap: 0.4rem;">
                            <button type="button" id="btn-select-all-shifts" class="btn btn-secondary btn-sm" style="font-size: 0.75rem; padding: 0.25rem 0.6rem;">Select All</button>
                            <button type="button" id="btn-deselect-all-shifts" class="btn btn-secondary btn-sm" style="font-size: 0.75rem; padding: 0.25rem 0.6rem;">Deselect All</button>
                        </div>
                    </div>
                    <div class="legend-container" id="shift-toggle-container">
                        <label class="legend-item shift-toggle-item" title="Click to toggle assignment of Full Day shift">
                            <input type="checkbox" class="shift-toggle-checkbox" value="F" checked style="accent-color: var(--shift-f);">
                            <span class="legend-color-box shift-F"></span>
                            <span>F (Full Day): 8:30am - 10:00pm</span>
                        </label>
                        <label class="legend-item shift-toggle-item" title="Click to toggle assignment of Morning shift">
                            <input type="checkbox" class="shift-toggle-checkbox" value="M" checked style="accent-color: var(--shift-m);">
                            <span class="legend-color-box shift-M"></span>
                            <span>M (Morning): 8:30am - 5:30pm</span>
                        </label>
                        <label class="legend-item shift-toggle-item" title="Click to toggle assignment of Night shift">
                            <input type="checkbox" class="shift-toggle-checkbox" value="N" checked style="accent-color: var(--shift-n);">
                            <span class="legend-color-box shift-N"></span>
                            <span>N (Night): 1:00pm - 10:00pm</span>
                        </label>
                        <label class="legend-item shift-toggle-item" title="Click to toggle assignment of Morning Weekend shift">
                            <input type="checkbox" class="shift-toggle-checkbox" value="Mw" checked style="accent-color: var(--shift-mw);">
                            <span class="legend-color-box shift-Mw"></span>
                            <span>Mw (Morning Weekend): 8:30am - 8:30pm</span>
                        </label>
                        <label class="legend-item shift-toggle-item" title="Click to toggle assignment of Night Weekend shift">
                            <input type="checkbox" class="shift-toggle-checkbox" value="Nw" checked style="accent-color: var(--shift-nw);">
                            <span class="legend-color-box shift-Nw"></span>
                            <span>Nw (Night Weekend): 11:00am - 10:00pm</span>
                        </label>
                        <label class="legend-item shift-toggle-item" title="Click to toggle assignment of Normal Cashier shift">
                            <input type="checkbox" class="shift-toggle-checkbox" value="No" checked style="accent-color: #64748b;">
                            <span class="legend-color-box shift-No"></span>
                            <span>No (Normal Cashier): 8:30am - 7:30pm</span>
                        </label>
                        <label class="legend-item shift-toggle-item" title="Click to toggle assignment of Night Cashier shift">
                            <input type="checkbox" class="shift-toggle-checkbox" value="Nh" checked style="accent-color: var(--shift-nh);">
                            <span class="legend-color-box shift-Nh"></span>
                            <span>Nh (Night Cashier): 10:30am - 9:30pm</span>
                        </label>
                        <label class="legend-item shift-toggle-item" title="Click to toggle assignment of Off Days">
                            <input type="checkbox" class="shift-toggle-checkbox" value="Off" checked style="accent-color: var(--shift-off);">
            ...
            <div class="floating-bar">
                <button class="btn btn-secondary" id="btn-undo" title="Undo last change" disabled>
                    <svg style="width: 14px; height: 14px; margin-right: 4px;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3"></path></svg>
                    Undo
                </button>
                <button class="btn btn-secondary" id="btn-redo" title="Redo next change" disabled>
                    <svg style="width: 14px; height: 14px; margin-right: 4px;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 15l6-6m0 0l-6-6m6 6H9a6 6 0 000 12h3"></path></svg>
                    Redo
                </button>
                <button class="btn btn-clear" id="btn-clear-roster">Clear Roster</button>
                
                <span class="floating-bar-divider"></span>
