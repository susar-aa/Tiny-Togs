...
CREATE TABLE IF NOT EXISTS `employees` (
    ...
    `role` ENUM('Rotating','Anchor','Cashier','Manager','Assistant_Manager') NOT NULL DEFAULT 'Rotating',
    `skill_tag` ENUM('General','Keyholder','Manager-on-Duty') NOT NULL DEFAULT 'General',
...
-- 5b. Roster History Table
-- Stores undo/redo snapshots of the monthly roster
...
INSERT INTO `employees` (`name`, `skill_level`, `gender`, `role`, `skill_tag`, `is_cashier`, `is_anchor`) VALUES
('Kumara',    'Good',   'Male',   'Rotating', 'General', 0, 0),
('Parami',    'Normal', 'Female', 'Cashier',  'General', 1, 0), -- Cashier
('Rishani',   'Normal', 'Female', 'Rotating', 'General', 0, 0),
('Nirasha',   'Good',   'Female', 'Rotating', 'General', 0, 0),
('Sansala',   'Normal', 'Female', 'Rotating', 'General', 0, 0),
('Pawani',    'Good',   'Female', 'Anchor',   'General', 0, 1), -- Anchor
('Abdul',     'Good',   'Male',   'Anchor',   'General', 0, 1), -- Anchor
('Deneth',    'Good',   'Male',   'Rotating', 'General', 0, 0),
('Hiruni',    'Normal', 'Female', 'Rotating', 'General', 0, 0),
('Thakshila', 'Normal', 'Female', 'Rotating', 'General', 0, 0),
('Sanduni',   'Good',   'Female', 'Rotating', 'General', 0, 0),
('Rashid',    'Good',   'Male',   'Anchor',   'General', 0, 1), -- Anchor
('Dhanushka', 'Normal', 'Male',   'Rotating', 'General', 0, 0),
('Anuhas',    'Good',   'Male',   'Anchor',   'General', 0, 1); -- Anchor -- Anchor
